...
Починаючи з 0.3.0, профілі Deep та Forensic збирають розширений аудит сховища у JSON-секцію Hardware.Disks.Deep:
...
- SMART PredictFailure, якщо клас доступний у системі.