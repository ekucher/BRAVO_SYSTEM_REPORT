...
Describe 'Get-BravoRuntimeAudit — PowerShell 7 full-version comparison' {
    ...
    It '7.4.0 проти найновішої відомої 7.6.0 — оновлення доступне' {
    ...
    It '7.6.0 проти найновішої відомої 7.6.0 — оновлення НЕ потрібне (рівні версії)' {
    ...
    It '7.6.5 проти найновішої відомої 7.6.0 — новіший за latest known, оновлення НЕ потрібне (раніше хибно позначалось як застаріле через Major/Minor-only порівняння)' {
