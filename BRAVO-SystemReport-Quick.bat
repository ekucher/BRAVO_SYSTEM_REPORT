...
title BRAVO SYSTEM REPORT - Quick
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT%" -Profile Quick -NoPause -NoOpenFolder -OutputPath "%REPORTS%"
